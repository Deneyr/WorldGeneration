...
{
    public class TundraTownGroundLandObject : ATownGroundLandObject
    {
        public TundraTownGroundLandObject(int landObjectId, LandType landType)
        ...
        public override ILandObject Clone(LandTransition wallLandTransition)
        {
            ...
            {
                TundraTownGroundLandObject townGroundLandObject = new TundraTownGroundLandObject(this.LandObjectId, this.Type);
        ...
        public override ILandObject Clone(LandType landType, LandTransition wallLandTransition)
        {
            ...
            if (landTransitionOverWall != LandTransition.NONE)
            {
                GroundLandObject townGroundLandObject = new TundraTownGroundLandObject(this.LandObjectId, landType);
                townGroundLandObject.LandTransition = landTransitionOverWall;
