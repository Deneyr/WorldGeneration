...
{
    public class TemperateForestTownGroundLandObject : ATownGroundLandObject
    {
        public TemperateForestTownGroundLandObject(int landObjectId, LandType landType)
        ...
        public override ILandObject Clone(LandTransition wallLandTransition)
        {
            ...
            {
                TemperateForestTownGroundLandObject townGroundLandObject = new TemperateForestTownGroundLandObject(this.LandObjectId, this.Type);
        ...
        public override ILandObject Clone(LandType landType, LandTransition wallLandTransition)
        {
            ...
            if (landTransitionOverWall != LandTransition.NONE)
            {
                GroundLandObject townGroundLandObject = new TemperateForestTownGroundLandObject(this.LandObjectId, landType);
                townGroundLandObject.LandTransition = landTransitionOverWall;
