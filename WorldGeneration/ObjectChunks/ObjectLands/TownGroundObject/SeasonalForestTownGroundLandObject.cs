...
{
    public class SeasonalForestTownGroundLandObject : ATownGroundLandObject
    {
        public SeasonalForestTownGroundLandObject(int landObjectId, LandType landType)
        ...
        public override ILandObject Clone(LandTransition wallLandTransition)
        {
            ...
            {
                SeasonalForestTownGroundLandObject townGroundLandObject = new SeasonalForestTownGroundLandObject(this.LandObjectId, this.Type);
        ...
        public override ILandObject Clone(LandType landType, LandTransition wallLandTransition)
        {
            ...
            if (landTransitionOverWall != LandTransition.NONE)
            {
                GroundLandObject townGroundLandObject = new SeasonalForestTownGroundLandObject(this.LandObjectId, landType);
                townGroundLandObject.LandTransition = landTransitionOverWall;
