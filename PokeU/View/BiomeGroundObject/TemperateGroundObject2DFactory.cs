...
{
    public class TemperateGroundObject2DFactory : AGroundObject2DFactory
    {
        protected override void InitializeFactory()
        {
            ...
            this.texturesPath.Add(@"Autotiles\grass");
            this.texturesPath.Add(@"Autotiles\mountain");
        ...
        public override IObject2D CreateObject2D(LandWorld2D landWorld2D, object obj, Vector2i position)
        {
            ...
            {
                return new TemperateGroundObject2D(this, groundLandObject, position, this.IsWall);
            }
            return null;
        }
    }
